        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CotacaoComercial = table.Column<decimal>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RendaFixa = table.Column<bool>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Configuracoes_AspNetUsers_UsuarioId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ContaContabil_Moeda_MoedaId",
                        column: x => x.MoedaId,
                        principalTable: "Moeda",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ContaContabil_AspNetUsers_UsuarioId",
                        column: x => x.UsuarioId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GrupoMovimentacoes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GrupoMovimentacoes_AspNetUsers_UsuarioId",
                        column: x => x.UsuarioId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TipoInvestimentoId = table.Column<int>(nullable: false),
                    UsuarioId = table.Column<string>(nullable: true),
                    ValorInvestido = table.Column<decimal>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Investimento", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Investimento_Moeda_MoedaId",
                        column: x => x.MoedaId,
                        principalTable: "Moeda",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Investimento_TipoInvestimento_TipoInvestimentoId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Objetivo_AspNetUsers_UsuarioId",
                        column: x => x.UsuarioId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContaContabilId = table.Column<int>(nullable: false),
                    ContaDestinoId = table.Column<int>(nullable: false),
                    Data = table.Column<DateTime>(nullable: false),
                    Descricao = table.Column<string>(nullable: true),
                    EscalaTempo = table.Column<int>(nullable: false),
                    GrupoMovimentacoesId = table.Column<int>(nullable: false),
                    MoedaId = table.Column<int>(nullable: false),
                    QtdTempo = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Movimentacao_ContaContabil_ContaContabilId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Movimentacao_GrupoMovimentacoes_GrupoMovimentacoesId",
                        column: x => x.GrupoMovimentacoesId,
                        principalTable: "GrupoMovimentacoes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HistoricoObjetivo", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HistoricoObjetivo_Objetivo_ObjetivoId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContaContabil_MoedaId",
                table: "ContaContabil",
                column: "MoedaId");

            migrationBuilder.CreateIndex(
                name: "IX_ContaContabil_UsuarioId",
                table: "ContaContabil",
                column: "UsuarioId");

            migrationBuilder.CreateIndex(
                name: "IX_GrupoMovimentacoes_UsuarioId",
                table: "GrupoMovimentacoes",
                column: "UsuarioId");

            migrationBuilder.CreateIndex(
                name: "IX_HistoricoObjetivo_ObjetivoId",
                table: "HistoricoObjetivo",
                column: "ObjetivoId");

            migrationBuilder.CreateIndex(
                name: "IX_Investimento_MoedaId",
                table: "Investimento",
                column: "MoedaId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Movimentacao_ContaContabilId",
                table: "Movimentacao",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Movimentacao_GrupoMovimentacoesId",
                table: "Movimentacao",
                column: "GrupoMovimentacoesId");
